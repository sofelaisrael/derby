...
class AppTheme {
  ...
  static const ColorScheme _darkScheme = ColorScheme(
    ...
    surfaceDim: Color(0xFF0D0E0C),
    surfaceBright: Color(0xFF1A1B18),
    surfaceContainerLowest: Color(0xFF0D0E0C),
    surfaceContainerLow: Color(0xFF141513),
    surfaceContainer: Color(0xFF141513),
    surfaceContainerHigh: Color(0xFF1A1B18),
    surfaceContainerHighest: Color(0xFF20211E),
